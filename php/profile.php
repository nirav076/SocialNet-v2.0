...
<html>
<head><link rel="shortcut icon" href="../images/favicon1.ico"/>
...
<div id="rowbuttons">
	...
	<input type="image" src="../images/logout.png" onmouseover="this.src='../images/logoutmo.png'" onmouseout="this.src='../images/logout.png'" alt="submit" height="45" width="80"/></form>
	</div>

	<div id="update">
		<form name="update" method="post" action="updateprofile.php">
		<input type="image" src="../images/update.png" onmouseover="this.src='../images/updatemo.png'" onmouseout="this.src='../images/update.png'" alt="submit" height="45" width="80"/>
		</form>
	</div>
