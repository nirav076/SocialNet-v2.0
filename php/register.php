...
<link rel="stylesheet" type="text/css" href="../css/emailval.css"/>
...
<td><input type="text" name="email" id="email" size="28" class="tb7"/></td> <td style="width:200px;"><p id="validateemail" class="email-nothing"></p></td>
</tr>
...
<div id="buttons">
<div id="b1">
<input type="image" src="../images/register.png" onmouseover="this.src='../images/registermo.png'" onmouseout="this.src='../images/register.png'" alt="submit" height="45" width="80" style="margin-left:24%;"/>
...
<a href="home.php" id="login">Login</a>
