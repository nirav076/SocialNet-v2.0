...
else
{
	...
	/*chdir('members_image');
		...
		if(is_dir('members_image/' . $id))
		{
			$img_path = 'members_image/' . $id;
		}
		else
		{
			mkdir('members_image/' . $id);
			$img_path = 'members_image/' . $id;
		}
	...
	$sql = "UPDATE members SET Name = '$name', Email = '$email' ,Gender = '$gender' ,Password = '$hashed_password', DOB = '$dob', Image = '$img_dir' WHERE ID = '$id'";
	mysql_query($sql);
	...
	echo '<form name="gotologin" action="home.php">';
	echo '<input type="image" src="../images/login.png" onmouseover="this.src=\'../images/loginmo.png\'" onmouseout="this.src=\'../images/login.png\'" alt="submit" height="45" width="80"/>';
	echo "</form>";
